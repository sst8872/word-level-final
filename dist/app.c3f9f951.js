...
var sheetIDs = {
  'level-1': '12RsjstgTSaRUhIjhPP--VCtERQqnpJwewXuN8xHr3PA',
  // 중1
  'level-2': '135pBkxhZkSpZtMZCoghDq_FQKmJV8RVNGsBqOvZnx2U',
  // 중2
  'level-3': '1YUJUlALBnPvtE5OiWNuZi1ZYYj-A2H0Hgx1MCVkY0hU',
  // 중3
  'free': '1p642D-8jC90_ZljtXsU8Jz67MHL0qRs0Yq8Zcefgrp8'
};
...
exports.default = void 0;
var apiURLs = {
  'level-1': 'https://script.google.com/macros/s/AKfycbxA2JRgPgYF7jZERFgAgJJREF6ZCCUCcSk6E6x0FL7Kb-jScLwr/exec',
  // 중1
  'level-2': 'https://script.google.com/macros/s/AKfycbwFZ8uV7OH2HNsyjkW7iOcfoCVJ6xsfHWGXm0Hoel_RTMTTn3U/exec',
  // 중2
  'level-3': 'https://script.google.com/macros/s/AKfycbzymFulJIKvZJyxtm87DKMkgjN-NlQnZvfRYE5IXsvseWoDO35A/exec',
  //  중3
...
exports.default = _default;
},{}],"js/editPassword.js":[function(require,module,exports) {
"use strict";
...
function passWordCheck(element, password) {
  ...
  while (trial < 3) {
    ...
    trial += 1;
    var password = prompt('Access Denied - Password Incorrect, Please Try Again.', 'Password');
  }

  if (password.toLowerCase() != "song" & trial == 3) history.go(-1);
  return " ";
}
...
var dropdown = document.querySelector('.dropdown'); // Event Listeners
...
},{"../css/loader.css":"css/loader.css","../css/style.css":"css/style.css","../css/navbar.css":"css/navbar.css","../spreadSheet/sheetIDs":"spreadSheet/sheetIDs.js","../spreadSheet/apiURLs":"spreadSheet/apiURLs.js","./fetchSheetsLength":"js/fetchSheetsLength.js","./exportToWords":"js/exportToWords.js","./makeTable":"js/makeTable.js","./editPassword":"js/editPassword.js"}],"../../../../AppData/Roaming/npm/node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
